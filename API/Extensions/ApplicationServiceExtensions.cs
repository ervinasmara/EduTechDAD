...
public static class ApplicationServiceExtensions
{
    ...
    /* Sekarang parameter pertama dari metode ekstensi ini adalah hal yang akan kita perluas daftar*/
    {
        ...
        services.AddCors(opt =>
        {
            ...
            {
                policy.AllowAnyHeader().AllowAnyMethod().WithOrigins("https://edutechibe.my.id", "https://www.edutechibe.my.id", "http://20.205.141.184", "http://localhost:5173", "https://edutechibe001.azurewebsites.net");
            });
        });
